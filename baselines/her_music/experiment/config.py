...
from baselines.her_music.ddpg import DDPG
from baselines.her_music.her import make_sample_her_transitions
...
DEFAULT_PARAMS = {
    ...
    'network_class_actor_critic': 'baselines.her_music.actor_critic:ActorCritic',
    'network_class_discriminator': 'baselines.her_music.discriminator:Discriminator',
