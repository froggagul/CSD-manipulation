...
import baselines.her_music.experiment.config as config
from baselines.her_music.rollout import RolloutWorker
from baselines.her_music.util import mpi_fork

import os.path as osp
import tempfile
import datetime
from baselines.her_music.util import (dumpJson, loadJson, save_video, save_weight, load_weight)
import pickle
...
def launch(
    env_name, n_epochs, num_cpu, seed, replay_strategy, policy_save_interval, clip_return, binding, logging, version, n_cycles, note, rollout_batch_size, override_params={}, save_policies=True):
